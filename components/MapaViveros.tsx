...
const icono = L.divIcon({
  className: "",
  html: `<div style="background:#b8502e;width:28px;height:28px;border-radius:50% 50% 50% 0;transform:rotate(-45deg);border:2px solid #fff;box-shadow:0 2px 6px rgba(44,26,32,.4)"></div>`,
  iconSize: [28, 28],
  iconAnchor: [14, 28],
});
